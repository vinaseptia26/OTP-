...
class AdminApprovalDetailBottomSheet extends StatelessWidget {
  ...
  const AdminApprovalDetailBottomSheet({
    super.key,
    required this.data,
  ...
  // ---------- LOKASI SECTION (dengan alamat lengkap + tombol peta) ----------
  ...
  // ---------- TABEL MITRA (dengan biaya per mitra) ----------
